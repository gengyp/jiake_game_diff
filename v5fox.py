...
def save_v5fox2db(appid,html):
  ...
  try:
    ...
    df.to_sql(name='game_v5fox_goods',con=engine,schema='{}'.format(cfg.SCHEMA_NAME),index=False,if_exists='append')
  except:
...
if __name__ == '__main__':
  ...
  cursor = conn.cursor()
  sql = "DELETE FROM {}.game_v5fox_goods".format(cfg.SCHEMA_NAME)
